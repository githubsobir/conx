...
class _PhotoCarDriverState extends ConsumerState<PhotoCarDriver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ref.watch(controllerCarPhoto6).boolGetData
          ? SafeArea(
              child: SafeArea(
                  child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: getImage(ref, 1) == "1"
                          ? Image.file(
                              ref.watch(controllerCarPhoto6.notifier).file2,
                              fit: BoxFit.cover,
                              height: 104,
                              width: MediaQuery.of(context).size.width * 0.4,
                            )
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: getImage(ref, 2) == "1"
                          ? Image.file(
                              ref.watch(controllerCarPhoto6.notifier).file3,
                              fit: BoxFit.cover,
                              height: 104,
                              width: MediaQuery.of(context).size.width * 0.4,
                            )
                    ...
                    GestureDetector(
                      ...
                      child: getImage(ref, 3) == "1"
                          ? Image.file(
                              ref.watch(controllerCarPhoto6.notifier).file4,
                              fit: BoxFit.cover,
                              height: 104,
                              width: MediaQuery.of(context).size.width * 0.4,
                            )
                      ...
                      child: MaterialButton(
                        onPressed: () {
                          if (checkAllFile()) {
                            ...
                            MyWidgets.snackBarMyWidgets(context: context, text: "Barcha rasmlarni kiriting");
                          }
                        },
                        height: 55,
