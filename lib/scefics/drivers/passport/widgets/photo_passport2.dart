...
class PhotoPassport2 extends ConsumerStatefulWidget {
  const PhotoPassport2({super.key});

  @override
  ConsumerState<PhotoPassport2> createState() => _PhotoPassport2State();
}

class _PhotoPassport2State extends ConsumerState<PhotoPassport2> {
  @override
